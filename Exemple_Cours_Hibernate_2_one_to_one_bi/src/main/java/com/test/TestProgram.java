...
public class TestProgram {
	 ...
	 * données et on supprime sa relation l'adresse. Dans une troisième
	 * session : on recharge de la base de données l'étudiant et on vérifie que
	 * l'étudiant n'a plus d'adresse
	 */
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Nombre d'adresses de l'étudiant avant suppression = " + (etd.getAdresse()==null?0:1));
		...
		try {
			...
			System.out.println("Nombre d'adresses de l'étudiant après suppression = " + (etd.getAdresse()==null?0:1));
